...
./submit.sh steer_multi --model apertus-base --dataset_name "sujet_finance_yesno_5k" --regression-model-type logit --time 07:00:00
./submit.sh steer_multi --model apertus-base --dataset_name "mmlu_high_school" --regression-model-type logit --time 07:00:00
./submit.sh steer_multi --model apertus-base --dataset_name "mmlu_professional" --regression-model-type logit --time 07:00:00
./submit.sh steer_multi --model apertus-base --dataset_name "sms_spam" --regression-model-type logit --time 07:00:00
./submit.sh steer_multi --model apertus-base --dataset_name "ARC-Challenge" --regression-model-type logit --time 07:00:00
./submit.sh steer_multi --model apertus-base --dataset_name "ARC-Easy" --regression-model-type logit --time 07:00:00

# ./submit.sh run_probes --model apertus-instruct --datasets mmlu_high_school mmlu_professional ARC-Challenge ARC-Easy sms_spam sujet_finance_yesno_5k --max-workers 70 --save-name both --alphas 0.01 0.02 --time 09:00:00
# ./submit.sh run_probes --model llama-instruct --datasets mmlu_high_school mmlu_professional ARC-Challenge ARC-Easy sms_spam sujet_finance_yesno_5k --max-workers 70 --save-name both --alphas 0.01 0.02 --time 09:00:00

# Use a mixture-trained probe to steer on a single dataset
# ./submit.sh steer_multi --model llama-instruct --dataset_name mmlu_high_school --probe-dataset-name "mmlu_high_school+mmlu_professional+ARC-Challenge+ARC-Easy+sms_spam+sujet_finance_yesno_5k" --regression-model-type logit --time 06:00:00
...
# ./submit.sh run_probes --model apertus-base --datasets ARC-Challenge --max-workers 60 --save-name both --alphas 0.01 0.02 0.05 --time 01:00:00
# ./submit.sh run_probes --model apertus-base --datasets ARC-Easy --max-workers 60 --save-name both --alphas 0.01 0.02 0.05 --time 01:00:00
# ./submit.sh run_probes --model apertus-base --datasets sujet_finance_yesno_5k --max-workers 50 --save-name both --alphas 0.01 0.02 0.05 --time 01:00:00